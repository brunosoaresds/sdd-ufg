                ...
                <table class="table table-striped table-valign-middle">
                    <thead>
                        <tr>
                            <th><?= $this->Paginator->sort('id', __('#ID')) ?></th>
                            <th><?= $this->Paginator->sort('name', __('Nome')) ?></th>
                            <th><?= $this->Paginator->sort('level', __('Nível')) ?></th>
                            <th width="200px"><?= __('Ações') ?></th>
                        </tr>
                    </thead>
                    <tbody>
					...
					<?php if(count($teacher->knowledges) < 1): ?>
						<tr>
							<td colspan="4" class="text-center">Esse docente não possui nenhum núcleo de conhecimento associado</td>
						</tr>
					<?php endif; ?>
